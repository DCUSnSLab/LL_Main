...
from .models import Shelter, Shelter_media, Community, Daily_Board, Issue_Board, \
Comment, Comment_media, Advertisement, Advertisement_media, \
Content, Content_Description

admin.site.register(Shelter)
admin.site.register(Shelter_media)
